...
export default function HowItWorks () {
  ...
  <div className=" px-4 mx-auto ">
    <div className="max-w-xl mx-auto mb-16 lg:mb-28 text-center ">
      ...
      <h2 className="mt-6 mb-12 text-6xl font-bold font-heading">Build and launch without problems</h2>
      <p className="text-lg text-gray-500">The brown fox jumps over the lazy dog.</p>
    </div>
    <div className="flex flex-wrap items-center -mx-10">
      <div className="relative w-full lg:w-1/2 px-10 mb-16 lg:mb-0">
        <div className="relative lg:max-w-md lg:ml-auto z-10">
          <img className="object-cover w-full lg:w-112 h-160" src="https://images.urbndata.com/is/image/FreePeople/78887346_061_a/?$a15-pdp-detail-shot$&fit=constrain&fmt=webp&qlt=80&wid=1080" alt="" />
          <div className="absolute bottom-0 left-0 w-full px-12">
            <div className="flex pt-10 pb-16 w-full border-t border-gray-200">
              ...
              <div>
                <p className="mb-1 text-lg font-bold text-blue-500">Zospace</p>
                <h4 className="text-4xl font-bold text-white">How it works</h4>
              </div>
            </div>
          </div>
        </div>
        <img className="hidden lg:block absolute top-0 right-0 mt-52 -mr-40" src={blueEclipse} alt="" />
      </div>
