import blueEclipse from './blue-eclipse.png'
...
export default function HowItWorks () {
  ...
  <div className="px-4 mx-auto ">
    <div className="max-w-xl mx-auto mb-16 lg:mb-28 text-center ">
      ...
      <h2 className="mt-6 mb-12 text-6xl font-bold font-heading">We help you build outfits that suit you.</h2>
      <p className="text-lg text-gray-500">This is how it works.</p>
    </div>
    <div className="flex flex-wrap items-center -mx-10">
      <div className="relative w-full lg:w-1/2 px-10 mb-16 lg:mb-0">
        <div className="relative lg:max-w-md lg:ml-auto z-10">
          <img className="object-cover w-full lg:w-112 h-160" src="https://images.urbndata.com/is/image/FreePeople/80092604_011_0/?$a15-pdp-detail-shot$&fit=constrain&fmt=webp&qlt=80&wid=720" alt="" />
          
{/* ************* */}
           <div className="absolute bottom-1/2 left-0 w-full px-12">
            <div className="flex pt-10 pb-16 w-full border-t border-gray-200">
              <a className="inline-flex mr-10 w-20 h-20 items-center justify-center bg-white rounded-lg" href="#">
                <svg className="-mb-2 -mr-2" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                <p className="mb-1 text-lg font-bold text-blue-500">a</p>
                <h4 className="text-4xl font-bold text-white">Top</h4>
              </div>
            </div>
          </div>

                     <div className="absolute bottom-1/4 left-0 w-full px-12">
            <div className="flex pt-10 pb-16 w-full border-t border-gray-200">
              <a className="inline-flex mr-10 w-20 h-20 items-center justify-center bg-white rounded-lg" href="#">
                <svg className="-mb-2 -mr-2" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0.791667 6.33333C0.354667 6.33333 0 5.97867 0 5.54167V3.95833C0 1.7765 1.7765 0 3.95833 0H5.54167C5.97867 0 6.33333 0.354667 6.33333 0.791667C6.33333 1.22867 5.97867 1.58333 5.54167 1.58333H3.95833C2.64892 1.58333 1.58333 2.64892 1.58333 3.95833V5.54167C1.58333 5.97867 1.22867 6.33333 0.791667 6.33333Z" fill="#1F40FF"></path>
              ...
              <div>
                <p className="mb-1 text-lg font-bold text-blue-500">simple</p>
...
{/* ***************** */}
            ...
            <div className="flex pt-10 pb-16 w-full border-t border-gray-200">
              ...
              <div>
                <p className="mb-1 text-lg font-bold text-blue-500">click</p>
                <h4 className="text-4xl font-bold text-white">Shoes</h4>
              </div>
            </div>
          </div>
        ...
        <img className="blue-img hidden lg:block absolute top-0 right-0 mt-52 -mr-40" src={blueEclipse} alt="" />
      </div>
      <div className="w-full lg:w-1/2 px-10">
        <div className="max-w-lg">
          ...
          <div className="mt-10 text-right">
            <a className="inline-block font-bold text-blue-500 hover:text-blue-600" href="#">
